...
function(copy_dependencies output_folder)
  if( PLATFORM_WINDOWS )
    file(COPY "${CHECKUP_3RD_BIN}/libcurl.dll" DESTINATION ${output_folder})
  endif ()
    file(COPY "${EGL_BINARIES}" DESTINATION ${output_folder})
    file(COPY "${GLES2_BINARIES}" DESTINATION ${output_folder})
    file(COPY "${MALI_BINARIES}" DESTINATION ${output_folder})
    file(COPY "${LOG4CPLUS_BINARIES}" DESTINATION ${output_folder})

  file(COPY "${CHECKUP_DATA_ROOT}/config.json" DESTINATION ${output_folder})
  file(COPY "${CHECKUP_DATA_ROOT}/openglessl" DESTINATION ${output_folder})
endfunction()
