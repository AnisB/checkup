...
if( PLATFORM_WINDOWS )
	...
	# SDL LIBRARY
	set(SDL_INCLUDE_DIRS "${CHECKUP_3RD_INCLUDE}/SDL")
	set(SDL_LIBRARIES "${CHECKUP_3RD_LIB}/SDL2.lib;${CHECKUP_3RD_LIB}/SDL2_image.lib;${CHECKUP_3RD_LIB}/SDL2main.lib;")
	set(SDL_BINARIES "${CHECKUP_3RD_BIN}/SDL2.dll")
